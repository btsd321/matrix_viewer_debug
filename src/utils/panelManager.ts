...
import { deflateImageData } from "./compressionUtils";
...
export class PanelManager {
    ...
    openImagePanel(
        ...
        const compressed = deflateImageData(data);
        ...
        try {
            ...
            switch (entry.kind) {
                case "image": {
                    ...
                    if (data) {
                        entry.panel.webview.postMessage({ type: "update", data: deflateImageData(data) });
                    }
                    break;
                }
                case "plot": {
